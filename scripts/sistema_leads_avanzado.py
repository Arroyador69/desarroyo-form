    ...
    def __init__(self):
        ...
        self.voice_scripts = {
            'restaurantes': {
                ...
                'propuesta': 'Me gustaría explicarle cómo podríamos ayudar a {nombre_negocio} a conseguir más clientes con una web que muestre su carta, permita reservas online y aumente sus ventas. Le hacemos la web completamente personalizada en 48 horas. ¿Le interesaría escuchar esta información?',
            ...
            'peluquerias': {
                ...
                'propuesta': 'Me gustaría explicarle cómo podríamos ayudar a {nombre_negocio} a conseguir más citas con una web que muestre sus trabajos y permita reservas online. Le hacemos la web completamente personalizada en 48 horas. ¿Le interesaría escuchar esta propuesta?',
            ...
            'default': {
                ...
                'propuesta': 'Me gustaría explicarle cómo podríamos ayudar a {nombre_negocio} a conseguir más clientes con una web profesional que atraiga y convierta visitas en ventas. Le hacemos la web completamente personalizada en 48 horas. ¿Le interesaría escuchar esta información?',
