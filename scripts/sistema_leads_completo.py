    ...
    def enviar_whatsapp(self, lead, mensaje):
        ...
        try:
            ...
            if not phone.startswith('+'):
                if phone.startswith('9') or phone.startswith('6') or phone.startswith('7'):
                    phone = '+34' + phone
                else:
                    phone = '+34' + phone
            ...
            print(f"✅ WhatsApp enviado a {lead['name']}: {phone}")
            return True
            
        except Exception as e:
            print(f"❌ Error enviando WhatsApp a {lead['name']}: {e}")
            return False
